...
<br>
<br>
```{r results MR, eval=FALSE, warning=FALSE, include=TRUE}
MR_AOV <- lmer(log10(metR+1) ~ time*Treat + (1|id), data=MR)
...
<img width="70%" src="/Users/marianavelasque/Dropbox/Pesquisa/Post-doc/Downling_lab/211010_trojan_females/Supplemental_material/Figures/gsea_plot_mit_edgeR.png"/>
<br>
